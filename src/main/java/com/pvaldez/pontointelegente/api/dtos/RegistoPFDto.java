...
public class RegistoPFDto {
	...
	@Length(min = 3, max = 200, message = "Email deve conter entre 3 a 200 caracteres")
	...
	public String toString() {
		return "RegistoPFDto [id=" + id + ", nome=" + nome + ", email=" + email + ", senha=" + senha + ", cpf=" + cpf
